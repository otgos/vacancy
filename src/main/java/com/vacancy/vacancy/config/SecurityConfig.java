...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin()
                ...
                .usernameParameter("user_mail") //<--input email type "email"
                .passwordParameter("user_password") //<-- input type "password
                .defaultSuccessUrl("/user/profile") //<--where to redirect after successful signin
        ...
        http.logout()
                ...
                .logoutUrl("/toExit");  //<-- url end point to sign out
        http.csrf().disable();
    }
    @Bean
